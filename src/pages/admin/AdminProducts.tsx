...
const emptyProduct = {
  ...
  price_ngn: 0,
  price_egp: 0,
  shipping_fee_ngn: 5000,
  service_fee_ngn: 2000,
  image_url: "",
  description: "",
  category_id: "",
  vendor_id: "",
...
export default function AdminProducts() {
  ...
  const openEdit = (product: Product) => {
    ...
    setForm({
      ...
      shipping_fee_ngn: product.shipping_fee_ngn || 5000,
      service_fee_ngn: product.service_fee_ngn || 2000,
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      shipping_fee_ngn: form.shipping_fee_ngn,
      service_fee_ngn: form.service_fee_ngn,
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input type="number" value={form.price_egp} onChange={(e) => setForm({ ...form, price_egp: Number(e.target.value) })} />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label>Shipping Fee (NGN)</Label>
                  <Input type="number" value={form.shipping_fee_ngn} onChange={(e) => setForm({ ...form, shipping_fee_ngn: Number(e.target.value) })} />
                </div>
                <div>
                  <Label>Service Fee (NGN)</Label>
                  <Input type="number" value={form.service_fee_ngn} onChange={(e) => setForm({ ...form, service_fee_ngn: Number(e.target.value) })} />
                </div>
              </div>
              <div>
